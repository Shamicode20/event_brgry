                    ...
                    <div class="border rounded">
                        <?php foreach ($items as $item) : ?>
                            <div class="d-flex align-items-center p-2">
                                <input class="form-check-input  item-checkbox ml-2" type="checkbox" 
                                       name="items[]" value="<?php echo htmlspecialchars($item['name']); ?>" 
                                       id="item_<?php echo $item['id']; ?>" onchange="toggleQuantity(this)">
                                <label class="form-check-label flex-grow-1 ml-8" for="item_<?php echo $item['id']; ?>">
                                    <?php echo htmlspecialchars($item['name']); ?>
                                </label>
                                <input type="number" name="quantity[<?php echo htmlspecialchars($item['name']); ?>]" 
                                       class="form-control quantity-input text-center" placeholder="Qty" min="1" 
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <p class="mt-3">Your request has been submitted successfully!</p>
            </div>
            <div class="modal-footer">
